...
RUN apt-get update && apt-get install --no-install-recommends -fy openjdk-7-jdk openjdk-6-jdk openjdk-6-jre openjdk-7-jre openjdk-6-jre-headless openjdk-7-jre-headless
